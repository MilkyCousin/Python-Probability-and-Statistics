...
adam_helper = AdamHelper(learning_rate=0.01, moment_decay_rate=0.9, rms_decay_rate=0.99)
nn_adam = Net(
    data_matrix=X_train,
    data_real=Y_train,
